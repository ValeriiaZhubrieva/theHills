(() => {
    ...
    let formValidate = {
        ...
        validateInput(formRequiredItem) {
            ...
            } else if (formRequiredItem.dataset.required === "phone") if (this.phoneTest(formRequiredItem)) {
                this.addError(formRequiredItem);
                this.removeSuccess(formRequiredItem);
                error++;
            } else {
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            const successClass = "form-sent-success";
            form.parentElement.classList.add(successClass);
            setTimeout((() => {
                form.parentElement.classList.remove(successClass);
            }), 5e3);
            setTimeout((() => {
    ...
    function addActiveClass(buttonsClass, activeClass) {
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (!isClickInsideButtons) buttons.forEach((item => {
    ...
    addActiveClass(".language__current", "lang-open");
    menuInit();
    spollers();
    formFieldsInit({
        viewPass: false,
